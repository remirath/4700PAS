...
epi{1}(185:195,1:149)= c_eps_0*11.3;
epi{1}(60:70,100:149)= c_eps_0*11.3;
epi{1}(60:70,60:90)= c_eps_0*11.3;
epi{1}(60:70,1:50)= c_eps_0*11.3;
...
bc{1}.xm.type = 'e';        % boundary conditions
bc{1}.xp.type = 'e';
bc{1}.ym.type = 'a';
bc{1}.yp.type = 'a';
